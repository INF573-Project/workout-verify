...
class ForwardStagehands(IForwardStage[DataStageInference, DataStageHands, TerminalStage]):
    ...
    def get_output(self) -> Tuple[TerminalStage, DataStageHands]:
        return TerminalStage(), DataStageHands(**self._output)